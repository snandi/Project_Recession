...
\section{Methods}
Total monthly household income was divided by monthly federal poverty level (FPL) and then averaged over quarters to estimate FPL100 ratio. If FPL100 ratio was below 1, then the household was below 100\% Federal poverty level in that quarter. Since monthly data were very strongly auto-correlated, averaging over quarters reduces 
